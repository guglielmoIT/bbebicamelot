...
namespace FileUploader
{
	public class Styles
	{
		public static void RegisterGlobalStyles()
		{
			...
			var pickerListStyle = new Style(typeof(Picker))
			{
				Setters = {
					new Setter { Property = Picker.TitleProperty, Value= "Foto Disponibili"},
					new Setter { Property = Picker.VerticalOptionsProperty, Value = LayoutOptions.StartAndExpand},
					new Setter { Property = Picker.HorizontalOptionsProperty, Value = LayoutOptions.CenterAndExpand}
				}
			...
			Application.Current.Resources.Add("PickerListStyle", pickerListStyle);
		}
	}
}
